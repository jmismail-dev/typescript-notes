...
const AddNote = (props) => {
    ...
    return (react_1.default.createElement(react_bootstrap_1.Container, { className: 'my-4' },
        ...
        react_1.default.createElement(react_bootstrap_1.Form.Group, null,
            react_1.default.createElement(react_bootstrap_1.Form.Control, { type: 'text', placeholder: 'Enter Title', onChange: handleTitleChange })),
        react_1.default.createElement("div", { className: "my-1" },
            react_1.default.createElement(react_markdown_editor_lite_1.default, { style: { height: '500px' }, allowPasteImage: true, value: getValue.text, renderHTML: text => (react_1.default.createElement(react_markdown_1.default, { children: text, rehypePlugins: [
                        rehype_sanitize_1.default
                    ] })), onChange: handleChange })),
        react_1.default.createElement(react_bootstrap_1.Button, { onClick: () => handleSubmit(), className: 'my-4' }, " Submit ")));
};
